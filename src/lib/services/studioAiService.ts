...
const KASB_AI_TOOLS = `
- Vibe Coding / AI Engineering: Cursor (Alternative: Bolt, Claude Code, Antigravity)
- Application Development (MVP): Lovable (Alternative: Replit, Base44)
- Automation & Agents: Manus AI (Alternative: Zapier)
- Pitch Deck & Presentations: Gamma (Alternative: Canva)
- Ad Campaigns & Marketing: Gemini (Alternative: Canva, Jasper)
...
- Research & Deep Dive (Any Complexity): Perplexity AI (Alternative: ChatGPT, Gemini)
- Video Generation (Any Complexity): Synthesia (Alternative: Runway, Sora)
- Image Generation: Midjourney (Alternative: Canva)
