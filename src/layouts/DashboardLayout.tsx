                ...
                <header className="sticky top-0 z-10 flex items-center border-b border-white/10 bg-black px-6 py-4">
                    <div className="flex-1 flex justify-center">
                        <div className="flex items-center gap-2.5">
                            <img src={`${import.meta.env.BASE_URL}logo.webp`} alt="Logo" className="h-7 w-auto rounded-md" />
    ...
    return (
        <div className="h-screen overflow-hidden bg-white flex flex-col md:flex-row">
            ...
            <div className="flex-1 flex flex-col min-w-0 md:pl-64 h-full bg-white">
                {/* Mobile Header */}
                <header className="sticky top-0 z-40 flex items-center bg-[#000000] border-b border-white/10 px-4 sm:px-6 py-4">
                    ...
                    <div className="flex-none flex items-center gap-2">
                        ...
                        <UsageIcon isMobile />
                        <Link 
                            to={`/dashboard/${role === 'admin' ? 'startup' : role || 'startup'}/messages`}
