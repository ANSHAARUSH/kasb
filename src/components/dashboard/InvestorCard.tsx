                                ...
                                <Button
                                    ...
                                    onClick={(e) => {
                                        ...
                                        if (investor.website) {
                                            ...
                                            // Only show modal for startups (if enabled). Otherwise, start timer and redirect.
                                            if (user && isEnabled) { // Assume role check is done inside the modal or we just let the modal handle it
