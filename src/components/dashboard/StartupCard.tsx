...
export function StartupCard({ startup, onClick, onDoubleClick, isSelected, isSaved = false, onToggleSave, onMessageClick, triggerUpdate, onConnectionChange }: StartupCardProps) {
    ...
    return (
        <Card
            ...
            className={cn(
                "group flex flex-col relative cursor-pointer transition-all duration-500 overflow-hidden border border-black shadow-sm h-auto sm:h-full",
            ...
            <CardContent className="p-6 flex-1 flex flex-col">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 sm:gap-0">
                    <div className="flex items-center gap-4">
                        <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-gray-100 text-3xl group-hover:scale-110 transition-transform duration-500 overflow-hidden">
                                ...
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        if (parent) {
                                            ...
                                            parent.className += ' font-bold text-gray-500'
