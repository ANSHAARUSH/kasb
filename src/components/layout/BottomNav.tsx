import { Home, User, Sparkles, Shield, History, FileText, Wrench, FileCheck } from "lucide-react"
...
export function BottomNav() {
    ...
    const navItems = [
        ...
        ...(isStartupDashboard ? [
            ...
            { icon: Wrench, label: "Studio", href: '/dashboard/startup/studio' },
            { icon: FileCheck, label: "Review", href: '/dashboard/startup/review' }
        ] : []),
