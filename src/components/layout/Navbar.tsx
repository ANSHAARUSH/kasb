...
export function Navbar() {
    ...
    return (
        <header className="fixed top-0 z-50 w-full bg-[#000000] shadow-lg border-b border-white/5">
            <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
                <Link to="/" className="flex items-center gap-2.5 z-50">
                    <img src={`${import.meta.env.BASE_URL}logo.webp`} alt="Logo" className="h-9 w-auto rounded-md" />
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className="fixed inset-0 bg-[#000000] z-[60] md:hidden"
                        ...
                        <motion.div
                            ...
                            className="fixed top-0 right-0 h-full w-[280px] bg-[#000000] border-l border-white/5 z-[70] p-6 shadow-2xl md:hidden flex flex-col"
                        >
                            ...
                            <div className="mt-auto flex flex-col gap-4 pt-8 border-t border-white/5">
                                <Link
                                    to="/login"
                                    className="text-center py-2.5 text-gray-400 font-medium hover:text-white transition-colors"
                                    onClick={() => setIsOpen(false)}
                                >
                                    Log In
                                </Link>
                                <Button asChild className="w-full h-12 rounded-full text-lg bg-white text-black hover:bg-gray-100 shadow-xl shadow-white/5">
