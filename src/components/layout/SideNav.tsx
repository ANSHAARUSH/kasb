import { Home, History, Sparkles, User, LogOut, Shield, FileText, Wrench, FileCheck } from "lucide-react"
...
export function SideNav() {
    ...
    const navItems = [
        ...
        ...(isStartupDashboard ? [
            ...
            { icon: FileCheck, label: "Kasb Review", href: '/dashboard/startup/review' }
        ] : []),
        ...
        <aside className="fixed left-0 top-0 z-50 hidden h-full w-64 flex-col border-r border-gray-100 bg-white md:flex">
            <div className="flex h-20 items-center px-6 border-b border-gray-50">
                <Link to="/" className="flex items-center gap-2.5">
                    <img src={`${import.meta.env.BASE_URL}logo.webp`} alt="Logo" className="h-8 w-auto rounded-md" />
