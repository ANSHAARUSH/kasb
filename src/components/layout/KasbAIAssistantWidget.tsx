                ...
                {isOpen && (
                    <motion.div
                        ...
                        animate={{ 
                            ...
                            scale: 1, 
                            x: 0,
                            // If user moved the button, try to keep the panel near it or at least not overlapping BottomNav
                            bottom: window.innerWidth < 768 ? '112px' : '24px'
                        }}
                        style={{
                            // Fix positioning for mobile when panel is open
                            bottom: window.innerWidth < 768 ? '112px' : '24px'
                        }}
                        exit={{ opacity: 0, y: 100, scale: 0.9, x: 20 }}
                        className="fixed right-6 w-[320px] sm:w-[350px] h-[480px] bg-white border border-gray-100 rounded-3xl shadow-2xl z-[9999] overflow-hidden flex flex-col transition-all"
                    >
                        {/* Header */}
                        <div className="p-4 bg-black text-white flex items-center justify-between shrink-0">
                            <div className="flex items-center gap-3">
                                <div className="h-10 w-10 rounded-xl bg-transparent flex items-center justify-center shadow-lg shadow-indigo-500/20 overflow-hidden border border-gray-100">
                                    <img src={`${import.meta.env.BASE_URL}kasb-assistant-avatar.webp`} alt="Kasb Assistant" className="h-full w-full object-cover" />
                                </div>
                        ...
                        >
                            {messages.length === 0 ? (
                                <div className="h-full flex flex-col items-center justify-center text-center space-y-8 py-4">
                                    ...
                                    >
                                        <img src={`${import.meta.env.BASE_URL}kasb-assistant-avatar.webp`} alt="Kasb Assistant" className="h-full w-full object-cover rounded-[2.5rem]" />
                                    </motion.div>
                                    <div>
