import { LayoutDashboard, Users, ShieldAlert, MessageSquare, Settings, LogOut, Flag, Bot, Megaphone } from "lucide-react"
import { cn } from "../../lib/utils"
import { Button } from "../ui/button"

export type AdminTab = 'overview' | 'users' | 'moderation' | 'messages' | 'reports' | 'settings' | 'custom_ai' | 'broadcast'
...
export function AdminLayout({ children, activeTab, setActiveTab, onLogout }: AdminLayoutProps) {
    const navItems = [
        ...
        { id: 'custom_ai', label: 'Custom AI', icon: Bot },
