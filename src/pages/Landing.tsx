...
import { RobotEyeTracker } from "../components/common/RobotEyeTracker"
...
function GlowCard({ children, className }: { children: React.ReactNode, className?: string }) {
    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none absolute inset-0 rounded-[inherit] border border-white/5 group-hover:border-white/20 transition-colors duration-500 z-30" />
        </div>
    );
}
...
export default function Landing() {
    ...
    return (
        <motion.div 
            style={{ 
                backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('${import.meta.env.BASE_URL}landing-background.webp')`,
        ...
        >
            ...
            <section id="hero" className="relative flex min-h-[90vh] lg:min-h-screen flex-col items-center justify-start px-4 pt-6 lg:pt-8 overflow-hidden" aria-labelledby="hero-title">
                {/* Immersive Background Elements - Animated Glowing Orbs */}
                <div className="absolute inset-0 -z-10 opacity-50 overflow-hidden mix-blend-screen">
                    <motion.div
                        animate={{ 
                            x: [0, 80, -40, 0], 
                            y: [0, -60, 80, 0],
                        ...
                        className="absolute top-[-10%] left-[-10%] h-[50vw] w-[50vw] rounded-full bg-indigo-900/40 blur-[120px]"
                    />
                    <motion.div
                        animate={{ 
                            x: [0, -80, 50, 0], 
                        ...
                        className="absolute bottom-[-10%] right-[-10%] h-[40vw] w-[40vw] rounded-full bg-[#DC143C]/30 blur-[120px]"
                    />
                    <motion.div
                        animate={{ 
                            x: [0, 40, -80, 0], 
                        ...
                        className="absolute top-[30%] left-[30%] h-[30vw] w-[30vw] rounded-full bg-purple-900/30 blur-[100px]"
                    />
                </div>
                ...
                >
                    ...
                    >
                        <TransparentHeroImage 
                            src={`${import.meta.env.BASE_URL}standing-man.webp`} 
            ...
            {/* In-between Robot Section */}
            <section className="py-16 flex flex-col items-center justify-center text-center relative z-10">
                <RobotEyeTracker 
                    src={`${import.meta.env.BASE_URL}robot-user-transparent.png`}
                    className="w-40 h-40 sm:w-56 sm:h-56 mb-8"
                />
                <h3 className={`text-2xl font-bold tracking-tight transition-colors ${isDarkMode ? "text-white" : "text-black"}`}>
                    AI-Driven Precision
                </h3>
                <p className={`mt-2 text-sm sm:text-base max-w-md mx-auto transition-colors ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
                    Our intelligent ecosystem is always watching, analyzing, and matching you with the perfect opportunity.
                </p>
            </section>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <TiltWrapper className="relative z-10 overflow-hidden rounded-[3rem] shadow-2xl">
                            <img
                                src={`${import.meta.env.BASE_URL}founders.webp`}
                        ...
                        <div className="grid gap-8 md:grid-cols-3 relative z-10">
                            {[
                                ...
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    className={`group rounded-[2.5rem] border p-10 shadow-sm transition-all duration-500 cursor-pointer transform-gpu perspective-1000 ${isDarkMode ? "bg-black/60 backdrop-blur-md border-white/10 text-white" : "bg-white border-gray-100 text-black"}`}
                                >
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-20 max-w-6xl mx-auto">
                    ...
                    >
                        <TiltWrapper className="animate-hero-float">
                            <TransparentHeroImage 
                                src={`${import.meta.env.BASE_URL}features-walker-clean.webp`} 
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {[
                        { 
                            ...
                            className: `lg:col-span-2 lg:row-span-2 bg-gradient-to-br from-white/5 to-transparent p-10 rounded-[2.5rem] ${isDarkMode ? "bg-black/60 backdrop-blur-md" : "bg-white"}`
                        },
                        { 
                            icon: Users, 
                            ...
                            className: `lg:col-span-1 p-10 rounded-[2.5rem] ${isDarkMode ? "bg-black/60 backdrop-blur-md" : "bg-white"}`
                        },
                        { 
                            icon: MessageSquare, 
                        ...
                        { 
                            ...
                            className: `lg:col-span-3 lg:col-start-1 p-10 rounded-[2.5rem] ${isDarkMode ? "bg-black/60 backdrop-blur-md" : "bg-white"} flex flex-col md:flex-row items-start md:items-center justify-between`
                        },
                    ].map((feature, i) => (
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-20 max-w-6xl mx-auto">
                        ...
                        >
                            <TiltWrapper className="animate-hero-float">
                                <TransparentHeroImage 
                                    src={`${import.meta.env.BASE_URL}how-it-works-man.webp`} 
                                    backgroundType="light"
                                    alt="Kasb AI Process" 
                    ...
                    <div className="grid gap-12 md:grid-cols-3">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className={`relative p-8 rounded-3xl shadow-sm border transition-all ${isDarkMode ? "bg-black/60 backdrop-blur-md border-white/10" : "bg-white border-gray-100"}`}
                            >
