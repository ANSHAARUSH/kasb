                                                ...
                                                <AnimatePresence>
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            className="group p-5 rounded-2xl border-2 border-gray-100 bg-gray-50/50 hover:bg-white hover:border-black hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] text-left transition-all duration-300"
                                                        >
