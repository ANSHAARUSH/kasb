                    ...
                    <AnimatePresence>
                        {isSummaryExpanded && selectedInvestor && (
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: 20 }}
                                className="flex flex-col bg-white rounded-t-3xl shadow-sm border-t border-gray-200 p-6 sm:p-8 mt-4 flex-1 overflow-y-auto min-h-0 relative z-0 overscroll-contain"
                            >
